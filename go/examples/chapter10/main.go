...
func main() {
	...
	middleMaterial := render.NewMaterial(render.NewColor(0.1, 1, 0.5), 0.1, 0.7, 0.3, 0, 0, 1, 200, patternRings)
	...
	leftMaterial := render.NewMaterial(render.NewColor(1, 0.8, 0.1), 0.1, 0.7, 0.3, 0, 0, 1, 200, patternStripes)
