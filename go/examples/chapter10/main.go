...
func main() {
	...
	floorMaterial := render.NewMaterial(render.NewColor(1, 0.9, 0.9), 0.1, 0.9, 0, 0, 200, patternCheckers)
	floor.SetMaterial(floorMaterial)
	world.AddObject(floor)

	middle := render.NewSphere()
	middle.SetTransform(render.Translation(-0.5, 1, 0.5))
	middleMaterial := render.NewMaterial(render.NewColor(0.1, 1, 0.5), 0.1, 0.7, 0.3, 0, 200, patternRings)
	...
	rightMaterial := render.NewMaterial(render.NewColor(0.5, 1, 0.1), 0.1, 0.7, 0.3, 0, 200, patternGradient)
	...
	leftMaterial := render.NewMaterial(render.NewColor(1, 0.8, 0.1), 0.1, 0.7, 0.3, 0, 200, patternStripes)
